    ...
    <>
      ...
      <section className="hero-section">
        <h1 className="hero-title">
          HRMS - Kidz (Human Resource Management System for Students)
        </h1>
        <p className="hero-description">
          HRMS - Kidz is a smart and efficient Human Resource Management System
          tailored for educational institutes to manage student attendance and
          movements.{" "}
        </p>
      ...
      <section className="cychallenges-section">
        <div className="cychallenges-header">
          <h2>Key Features</h2>
          {/* <p>
            Our system addresses the complex challenges of cylinder inventory
            management in godowns, making tracking and record-keeping simple and
            efficient.
          </p> */}
        </div>
          ...
          {[
            {
              ...
              desc: "Track student attendance using real-time GPS location and photo verification, ensuring authenticity and accuracy.",
              icon: "🔍",
            },
            {
              title: "Photo Verification",
              desc: "Capture live student photos during check-in and check-out to prevent proxy attendance and improve safety.",
              icon: "📸",
            },
            {
              title: "Location-Based Tracking",
              desc: "Automatically verify student presence by checking their live location against the school’s geofence.",
              icon: "📍",
            },
            {
              title: " Entry & Exit Logs",
              desc: "Monitor when students enter or leave the campus with complete time-stamped records for transparency.",
              icon: "🚪",
            },
          ].map((item, idx) => (
      ...
      <div className="hrmkey-features-container">
        ...
        <div className="hrmfeatures-grid">
          ...
          <div className="hrmfeature-card featured">
            ...
            <p className="hrmfeature-description">
              Our professional attendance tracking module records when student
          ...
          <div className="hrmfeature-card">
            <h3 className="hrmfeature-title">Student Management</h3>
            <p className="hrmfeature-subtitle">
              Centralized student information
            </p>
            <div className="hrmimage-placeholder2"></div>
            <p className="hrmfeature-description">
              Store and manage all student information in one secure location.
              Track studentst history, personal details, documents, and
              performance metrics.
            </p>
            <ul className="hrmfeature-list">
              <li>✔ Student profiles and records</li>
        ...
        <div className="hrmbottom-section">
          ...
          <div className="hrmbottom-content">
            <h3 className="hrmfeature-title">
              Mobile Access for Parents & Staff
            </h3>
            <p className="hrmfeature-description">
              Our companion mobile app puts attendance information at your
              fingertips:
            </p>
            <ul className="hrmfeature-list">
              <li>Real-time attendance notifications</li>
              <li>Historical attendance records</li>
              <li>Absence reporting for parents</li>
              <li>Direct messaging with school staff</li>
              <li>Permission slips and attendance exemption requests</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="hrheader-section">
        ...
        <div className="hrheader-content">
          ...
          <h1>
            Student <span className="hrhighlight">ATTENDANCE</span> Management
            System
          </h1>
          <p>
            A secure and comprehensive solution for tracking student attendance,
            monitoring check-in/check-out times, and maintaining detailed
            attendance history for educational institutions.
          </p>
          <a href="/">
      ...
      <div className="impact-wrapper">
        ...
        <div className="cta-section">
          <h2 className="cta-heading">Ready to Experience HRMS-KIDZ?</h2>
          <p className="cta-text">
            Our HRMS-KIDZ solution provides everything you need to manage your
